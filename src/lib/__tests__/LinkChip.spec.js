...
const raw =
    '';
...
describe('Test Link Chip', () => {
    it('Convert Navi hex to Navi Object', () => {
        expect(LinkChip.toObject(raw)).toStrictEqual(obj);
    });

    it('Convert Navi Object to Navi Hex', () => {
        expect(LinkChip.toRaw(obj).raw).toStrictEqual(raw);
    });

    it('Invalid Navi data too big', () => {
        try {
            const tmp = { ...obj };
            tmp.attack.value = 256;
            LinkChip.toRaw(tmp);
        } catch (error) {
            expect(error.message).toBe('Field [attack] contains invalid data.');
        }
    });

    it('Invalid Navi data too small', () => {
        try {
            const tmp = { ...obj };
            tmp.attack.value = -1;
            LinkChip.toRaw(tmp);
    ...
    it('Pinout should end up being a bin', () => {
        expect(LinkChip.pinoutToBin('010100000100')).toBe('0000000010000010');
    });
});
